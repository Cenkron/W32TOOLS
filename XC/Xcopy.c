...
helpline [] =
    ...
    static char 
optstring [] =
    "aAbcdDefhklLmnoO:pPqQrRsSuUvVxX:yY:z?";

/* options used: aAb c dDe f   h     k lLm n oOpPqQrRsS  uUvV  xXyYz  */
/* options left:    B C   E FgG HiIjJ K   M N          tT    wW     Z */
...
main (int argc, char *argv[])
    ...
    while ((c=getopt(argc, argv, optstring)) != EOF)
        switch (c)
          ...
          //case 'w': azFlags.w  = !azFlags.w;  break; /*   -- unused --    */
