...
/* ----------------------------------------------------------------------- */
    void
buildpat (argv)			/* Build the pattern from the argv list */
...
tokenize ()                     // Separate the input line into tokens
...
/* ----------------------------------------------------------------------- */
    void
buildcmd ()		/* Build a command from the pattern and data */
...
/* ----------------------------------------------------------------------- */
    int				/* Return 0, or (-1) if error */
exec (s)			/* Execute the built command */
...
/* ----------------------------------------------------------------------- */
    void
batch (p)			/* Write batch output from the command line */
