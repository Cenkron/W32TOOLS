...
/* ----------------------------------------------------------------------- */
    void
filepair1 (s1, s2)		/* Process the pathnames forward */
...
/* ----------------------------------------------------------------------- */
    void
filepair2 (s1, s2)		/* Process the pathnames backward */
    char  *s1;			/* Pointer to the pathname1 string */
    char  *s2;			/* Pointer to the pathname2 string */
...
/* ----------------------------------------------------------------------- */
    void
process (fnp1, fnp2)		/* Compare one pair one of input files */
...
unixcomp (fd1, fd2)		/* Compare the data of two open files */
    int  fd1;
    int  fd2;
...
/* ----------------------------------------------------------------------- */
    int				/* Return TRUE if they are different */
datacomp (fd1, fd2)		/* Compare the data of two open files */
    int  fd1;
    int  fd2;
...
/* ----------------------------------------------------------------------- */
    void
cantfind (fnp)			/* Inform user of input failure */
