...
sgettd (char *s)		/* Pointer to the time/date string */
...
str_parse (char *s)		/* Pointer to the string */
...
\* ----------------------------------------------------------------------- */
    static void
phr_init (PHRASE *pp)		/* Pointer to the PHRASE structure */
...
str_find (char *s)		/* Pointer to the search string */
...
\* ----------------------------------------------------------------------- */
    static int			/* Return the parse validity result */
phr_reduce (PHRASE *pp)		/* Pointer to the PHRASE structure */
...
/* ----------------------------------------------------------------------- */
    static int
datematch (PHRASE *pp)		/* Pointer to the PHRASE structure */
...
/* ----------------------------------------------------------------------- */
    static int
timematch (PHRASE *pp)		/* Pointer to the PHRASE structure */
...
fld_find (UINT16 attr)		/* The specified attribute */
