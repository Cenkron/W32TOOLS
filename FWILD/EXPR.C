...
expr (long  *pret_value)	/* Pointer to the returned value */
...
\* ----------------------------------------------------------------------- */
    static int			/* Return ERROR_* */
term (long  *pret_value)	/* Pointer to the returned value */
...
\* ----------------------------------------------------------------------- */
    static int			/* Return ERROR_* */
factor (long  *pret_value)	/* Pointer to the returned value */
...
\* ----------------------------------------------------------------------- */
    static int			/* Return ERROR_* */
number (long  *pret_value)	/* Pointer to the returned value */
...
\* ----------------------------------------------------------------------- */
    static void
error (int  err_value)		/* The error code */
